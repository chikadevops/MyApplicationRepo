pipeline {
    ...
    stages {
        ...
        stage('Nexus Upload') {
            steps {
                nexusArtifactUploader artifacts: [[artifactId: 'MyWebApp', classifier: '', file: 'MyWebApp/target/MyWebApp.war', type: 'war']], credentialsId: '897de581-aca3-4f9f-bb8b-a7175d56be2b', groupId: 'MyWebApp', nexusUrl: 'ec2-3-92-50-243.compute-1.amazonaws.com:8081/', nexusVersion: 'nexus3', protocol: 'http', repository: 'maven-snapshots', version: '1.0-SNAPSHOT'
            }
        }
        
        stage('DEV Deploy') {
            steps {
                deploy adapters: [tomcat9(credentialsId: 'c43d606a-b19e-4ff6-99e8-af1561b3cea4', path: '', url: 'http://ec2-52-91-101-57.compute-1.amazonaws.com:8080/')], contextPath: null, war: '**/*.war'
            }
        }
